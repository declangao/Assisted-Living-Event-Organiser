...
public class Util {
     ...
     */
    private static final String SHARED_PREFS = "af5".toUpperCase(Locale.ENGLISH) + "_PREFS";
    ...
    public static String getBaseUrl(Context context) {
        ...
        //return url;
        //return new String("http://afdeclan.appspot.com");
        return new String("http://aleowintec.appspot.com");
    }
    ...
    private static String getDebugUrl(Context context) {
        ...
        //return new String("http://assistedfreedom.appspot.com");
    }
