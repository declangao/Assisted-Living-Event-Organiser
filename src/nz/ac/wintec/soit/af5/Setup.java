...
public class Setup {
     ...
     * below.
     */
   // private static final String APP_NAME = "awhinatuara";
    private static final String APP_NAME = "assistedfreedom";

    /**
     * The URL of the production service.
     */
    //public static final String PROD_URL = "https://" + APP_NAME + ".appspot.com";
    public static final String PROD_URL = "http://10.0.2.2:8888";

    /**
     * The C2DM sender ID for the server. A C2DM registration with this name
     * must exist for the app to function correctly.
     */
    public static final String SENDER_ID = "timhot@gmail.com";
}
